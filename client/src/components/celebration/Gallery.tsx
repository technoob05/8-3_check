...
export default function Gallery() {
  ...
  const stories = [
    {
      image: '/1.jpg',
      caption: 'Lần đầu tiên chụp hình một cặp với Bé',
      date: 'Kỷ niệm đầu tiên',
    },
    {
      image: '/2.png',
      caption: 'Lần đầu tiên đi date',
      date: 'Ngày đáng nhớ',
    },
    {
      image: '/3.jpg',
      caption: 'Lần đầu tiên đi sinh nhật của Bé',
      date: 'Sinh nhật đặc biệt',
    },
    {
      image: '/5.png',
      caption: 'Đi chơi Tết cùng nhau',
      date: 'Tết đoàn viên',
    },
    {
      image: '/6.png',
      caption: 'Sinh nhật của Bé gần nhất',
      date: 'Tuổi mới, hạnh phúc mới',
    },
    {
      image: '/7.jpg',
      caption: 'Sinh nhật của Tin gần nhất',
      date: 'Hạnh phúc bên nhau',
    },
    {
      image: '/8.jpg',
      caption: 'Chúc mừng ngày 8/3 Bé yêu',
      date: 'Từ Tin với tất cả yêu thương',
    },
  ];
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-center mb-6 text-pink-600">Câu Chuyện Yêu Thương</h2>
